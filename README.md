...
#  About this tool
FindOverlapMatch looks for overlapping samples in a sample matrix. It compares samples and lists similar samples
based on a cutoff point.

#  Documentation
For documentation and manuals visit the [readthedocs page](http://biopet-findoverlapmatch.readthedocs.io/en/latest/).
